...
uses
  ...
  Vcl.StdCtrls, Vcl.ComCtrls; // Added Vcl.ComCtrls for TPageControl
...
type
  TForm1 = class(TForm)
    ...
    Series20: TBarSeries;
    Series13: TBarSeries;
    PageControl1: TPageControl; // Added declaration
    TabSheet1: TTabSheet;       // Added declaration
    TabSheet2: TTabSheet;       // Added declaration
...
// The implementation section remains exactly as you provided it.
{$R *.dfm}
